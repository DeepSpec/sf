...
(** **** Exercise: 3 stars, standard (sort_contents) 
...
(** **** Exercise: 3 stars, standard (delete_contents)  *)
...
(** **** Exercise: 2 stars, standard (contents_perm_aux)  *)
...
(** **** Exercise: 2 stars, standard (contents_in)  *)
Lemma contents_in:
...
(** **** Exercise: 2 stars, standard (in_perm_delete)  *)
...
(** **** Exercise: 4 stars, standard (contents_perm)  *)
Lemma contents_perm:
